                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100 transition-colors">
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-semibold text-gray-900">
                            <a href="{{ route('work-orders.show', ['wo' => $wo->id]) }}" class="text-blue-600 hover:text-blue-800 hover:underline">
                                {{ $wo->wo_number }}
                            </a>
                        </td>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('work-orders.show', ['wo' => $wo->id]) }}" class="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white p-2 rounded shadow transition" title="View">
