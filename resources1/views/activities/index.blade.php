                    ...
                    <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100 transition-colors">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-center">
                            <div class="flex flex-row justify-center items-center gap-2">
                                <a href="{{ route('activities.show', ['activity' => $activity->id]) }}" class="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white p-2 rounded shadow transition duration-150 ease-in-out" title="View">
                                ...
                                @if(Auth::user()->role !== 'mekanik')
                                    ...
                                    <form action="{{ route('activities.destroy', ['activity' => $activity->id]) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
