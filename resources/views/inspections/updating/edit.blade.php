...
<div class="w-full p-4 sm:p-6 lg:p-8">
    <div class="w-full mx-auto max-w-6xl">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Inspeksi</h1>
        ...
        <form action="{{ route('inspections.updating.update', $inspection->id) }}" method="POST" id="inspectionForm">
            @csrf
            @method('PUT')
                        ...
                        <select name="machine_erp_id" id="machine_erp_id" class="w-full border rounded px-3 py-2 @error('machine_erp_id') border-red-500 @enderror" required onchange="loadTemplate()">
                            ...
                            @foreach($machines as $machine)
                                <option value="{{ $machine->id }}" 
                                        ...
                                        {{ old('machine_erp_id', $inspection->machine_erp_id) == $machine->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="performed_by" id="performed_by" class="w-full border rounded px-3 py-2 @error('performed_by') border-red-500 @enderror">
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('performed_by', $inspection->performed_by) == $user->id ? 'selected' : '' }}>
