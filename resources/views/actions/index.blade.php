    ...
    <div x-show="extractModalOpen" 
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto"
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Extract Actions from Downtime</h3>
            </div>
            <div class="p-6">
                ...
                <div x-show="!previewLoaded" class="mb-4">
                    ...
                    <button 
                        ...
                        @click="
                            ...
                            loading = true;
                            fetch('{{ route('actions.preview-from-downtime') }}', {
                                method: 'POST',
                                headers: {
                ...
                <template x-if="previewLoaded && previewData">
                    <div class="space-y-4">
                                        ...
                                        <template x-if="previewData?.sample_data && previewData.sample_data.length > 0">
                                            <template x-for="(item, index) in previewData.sample_data" :key="index">
                                                <tr class="border-b">
                                                    ...
                                                    <td class="px-3 py-2" x-text="item.action || ''"></td>
                                                </tr>
                                            </template>
                                        </template>
                                        <template x-if="!previewData?.sample_data || previewData.sample_data.length === 0">
                        ...
                        <form method="POST" action="{{ route('actions.extract-from-downtime') }}" id="extractForm">
                            @csrf
