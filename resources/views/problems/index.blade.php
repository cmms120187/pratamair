    ...
    <div x-show="extractModalOpen" 
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto"
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Extract Problems from Downtime</h3>
            </div>
            <div class="p-6">
                ...
                <div x-show="!previewLoaded" class="mb-4">
                    ...
                    <button 
                        ...
                        @click="
                            ...
                            loading = true;
                            fetch('{{ route('problems.preview-from-downtime') }}', {
                                method: 'POST',
                                headers: {
                ...
                <template x-if="previewLoaded && previewData">
                    <div class="space-y-4">
                                ...
                                <table class="min-w-full text-sm">
                                    <thead class="bg-gray-200">
                                        <tr>
                                            ...
                                            <th class="px-3 py-2 text-left">Problem Name</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <form method="POST" action="{{ route('problems.extract-from-downtime') }}" id="extractForm">
                            @csrf
