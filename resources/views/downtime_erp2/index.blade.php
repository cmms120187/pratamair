            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-600">
                    <tr>
                        ...
                        <x-sortable-header column="date" :currentSort="($sortBy ?? 'date')" :currentDir="($sortDir ?? 'desc')" label="Date" />
                        <x-sortable-header column="kode_room" :currentSort="($sortBy ?? 'date')" :currentDir="($sortDir ?? 'desc')" label="Kode Room" />
                        <x-sortable-header column="plant" :currentSort="($sortBy ?? 'date')" :currentDir="($sortDir ?? 'desc')" label="Plant" />
