                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="number" name="part_quantity" id="part_quantity" min="0" value="{{ old('part_quantity', $downtimeErp2->part_quantity ?? 0) }}" placeholder="0"
                                   class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    ...
                    <div>
                        ...
                        <select name="system_id" id="system_id" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition @error('system_id') border-red-500 @enderror">
                            ...
                            @foreach($systems as $system)
                                <option value="{{ $system['id'] }}" {{ old('system_id', $downtimeErp2->system_id) == $system['id'] ? 'selected' : '' }}>
                                    {{ $system['nama_sistem'] }}
                                </option>
                            @endforeach
                        </select>
...
document.addEventListener('DOMContentLoaded', function() {
    if (systemSelect && currentSystemIds && currentSystemIds.length > 0) {
        ...
        setTimeout(function() { if (typeof updatePartStockNotif === 'function') updatePartStockNotif(); }, 500);
    }
});
