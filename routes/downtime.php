...
// Downtime routes (Shortened: /dt/...)
Route::middleware('auth')->prefix('dt')->group(function () {
    ...
    Route::post('derp/search-machine', [DowntimeErpController::class, 'searchMachine'])->name('downtime_erp.search-machine');
