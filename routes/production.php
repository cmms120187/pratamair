...
Route::middleware('auth')->prefix('prod')->group(function () {
    ...
    Route::resource('phourly', \App\Http\Controllers\ProductionHourlyController::class);
    ...
    Route::resource('pdaily', \App\Http\Controllers\ProductionDailyController::class);
});
