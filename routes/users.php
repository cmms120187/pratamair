...
// Users routes (Shortened: /usr/...)
Route::middleware('auth')->prefix('usr')->group(function () {
    // Activity Routes
    ...
    Route::middleware('role:coordinator,ast_manager,manager,general_manager')->group(function () {
        ...
        Route::get('users/org-structure', [\App\Http\Controllers\OrganizationalStructureController::class, 'index'])->name('users.organizational-structure.index');
        Route::get('users/org-structure/chart', [\App\Http\Controllers\OrganizationalStructureController::class, 'chart'])->name('users.organizational-structure.chart');
        Route::resource('users', UserController::class);
    });
    
    // Permissions Management - Admin only
    Route::middleware('role:admin')->group(function () {
        Route::get('perms', [\App\Http\Controllers\PermissionController::class, 'index'])->name('permissions.index');
        Route::put('perms', [\App\Http\Controllers\PermissionController::class, 'update'])->name('permissions.update');
    });
});
